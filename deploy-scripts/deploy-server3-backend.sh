#!/bin/bash
# =====================================================
# Deploy Backend Service - Server 3
# =====================================================
# Chạy script này trên Server 3 (Backend API)
# IP Server 3: 192.168.1.30 (thay đổi nếu cần)

echo "🚀 Deploying Backend Service trên Server 3..."
echo ""
...
echo "   - Backend API:  http://192.168.1.30:8000"
echo ""
echo "🧪 Test Backend API:"
echo "   curl http://192.168.1.30:8000/api/cameras"
echo ""
echo "📊 View logs:"
