#!/bin/bash
# =====================================================
# Deploy Frontend Service - Server 3
# =====================================================
# Chạy script này trên Server 3 (Frontend Web)
# IP Server 3: 192.168.1.30 (thay đổi nếu cần)

echo "🚀 Deploying Frontend Service trên Server 3..."
echo ""
...
echo "   VITE_API_BASE_URL=http://[IP_SERVER_2]:8000"
echo ""
...
echo "   - Frontend Web:  http://192.168.1.30:3000"
echo ""
echo "🌐 Mở trình duyệt:"
