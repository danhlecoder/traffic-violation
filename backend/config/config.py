...
class Settings:
    ...
    def _load_env_params(self):
        ...
        self.STOPLINE_CROSSING_THRESHOLD: int = int(os.getenv("STOPLINE_CROSSING_THRESHOLD", "10")) if os.getenv("STOPLINE_CROSSING_THRESHOLD") else 10
        self.STOPLINE_DETECTION_RANGE: int = int(os.getenv("STOPLINE_DETECTION_RANGE", "20")) if os.getenv("STOPLINE_DETECTION_RANGE") else 20
        self.STOPLINE_CROSSING_TIMEOUT: int = int(os.getenv("STOPLINE_CROSSING_TIMEOUT", "30")) if os.getenv("STOPLINE_CROSSING_TIMEOUT") else 30
        ...
        # Object Tracking
        self.TRACKER_IOU_THRESHOLD: float = float(os.getenv("TRACKER_IOU_THRESHOLD", "0.3"))
        self.TRACKER_MAX_AGE: int = int(os.getenv("TRACKER_MAX_AGE", "30"))
        self.TRACKER_MIN_HITS: int = int(os.getenv("TRACKER_MIN_HITS", "3"))
        
        # ROI State Tracking
        self.ROI_STATE_CLEANUP_TIMEOUT: int = int(os.getenv("ROI_STATE_CLEANUP_TIMEOUT", "120"))
        
        # Stopline Crossing
        self.STOPLINE_CROSSING_THRESHOLD: float = float(os.getenv("STOPLINE_CROSSING_THRESHOLD", "10"))
        self.STOPLINE_CROSSING_TIMEOUT: int = int(os.getenv("STOPLINE_CROSSING_TIMEOUT", "60"))
