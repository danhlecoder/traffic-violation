...
class Track:
    ...
    def __init__(self, bbox: List[float], class_name: str, confidence: float, frame_id: int):
        Track._count += 1
    ...
    def mark_missed(self):
        ...
        elif self.time_since_update > 30:  # Lost sau 30 frames (~1s)
...
class ObjectTracker:
    ...
    def update(self, detections: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        if len(low_conf_dets) > 0 and len(unmatched_tracks) > 0:
            ...
            matched_tracks2, unmatched_tracks2, _ = self._match(
